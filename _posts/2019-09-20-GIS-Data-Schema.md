...
For the data inside the City of Zanesville database
```sql
...
* fema
* census
* esri (Esri data from the downloadable datasets should not be hosted online unless Terms of Service for that layer explicitly allows publishing)
